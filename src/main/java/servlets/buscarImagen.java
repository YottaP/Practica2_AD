...
public class buscarImagen extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Image> resultados = db.buscarImagenes(title, description, keywords, 
            ...
            out.println("<p><strong>Usuario actual:</strong> " + usuarioActual + "</p>");
            ...
            if(resultados == null || resultados.isEmpty()) {
                ...
                for(Image img : resultados) {
                    ...
                    out.println("<td>" + img.getCreator() + "</td>");
                    out.println("<td>" + img.getCaptureDate() + "</td>");
                    out.println("<td>" + img.getStorageDate() + "</td>");
                    //out.println("<td>" + escapeHtml(img.getFilename()) + "</td>");
